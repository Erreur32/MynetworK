...
/** Logs a route failure and sends the standard 500 `{ success: false, error: { message, code } }` payload. */
function sendScanError(res: Response, logMessage: string, error: unknown, fallbackMessage: string, code: string) {
    logger.error('NetworkScan', `${logMessage}:`, error);
...
router.post('/refresh', requireAuth, requireAdmin, autoLog('network-scan', 'refresh'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Refresh failed', error, 'Refresh failed', 'REFRESH_ERROR');
    }
}));
...
router.get('/history', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to get history', error, 'Failed to get history', 'HISTORY_ERROR');
    }
}));
...
router.get('/stats', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get stats', error, 'Failed to get stats', 'STATS_ERROR');
    }
}));
...
router.get('/stats-history', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get stats history', error, 'Failed to get stats history', 'STATS_HISTORY_ERROR');
    }
}));
...
router.get('/insights', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get insights', error, 'Failed to get insights', 'INSIGHTS_ERROR');
    }
}));
...
router.get('/config', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get config', error, 'Failed to get config', 'CONFIG_ERROR');
    }
}));
...
router.post('/config', requireAuth, requireAdmin, autoLog('network-scan', 'config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to save config', error, 'Failed to save config', 'CONFIG_SAVE_ERROR');
    }
}));
...
router.get('/refresh-config', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get refresh config', error, 'Failed to get refresh config', 'CONFIG_ERROR');
    }
}));
...
router.post('/refresh-config', requireAuth, requireAdmin, autoLog('network-scan', 'refresh-config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to save refresh config', error, 'Failed to save refresh config', 'CONFIG_SAVE_ERROR');
    }
}));
...
router.get('/default-config', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get default config', error, 'Failed to get default config', 'CONFIG_ERROR');
    }
}));
...
router.post('/default-config', requireAuth, requireAdmin, autoLog('network-scan', 'default-config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to save default config', error, 'Failed to save default config', 'CONFIG_SAVE_ERROR');
    }
}));
...
router.get('/unified-config', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get unified config', error, 'Failed to get unified config', 'CONFIG_ERROR');
    }
}));
...
router.get('/auto-status', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get auto status', error, 'Failed to get auto status', 'STATUS_ERROR');
    }
}));
...
router.get('/retention-config', requireAuth, requireAdmin, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get retention config', error, 'Failed to get retention config', 'RETENTION_CONFIG_ERROR');
    }
}));
...
router.post('/retention-config', requireAuth, requireAdmin, autoLog('network-scan', 'retention-config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to save retention config', error, 'Failed to save retention config', 'RETENTION_CONFIG_ERROR');
    }
}));
...
router.get('/database-stats', requireAuth, requireAdmin, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get database stats', error, 'Failed to get database stats', 'DATABASE_STATS_ERROR');
    }
}));
...
router.get('/plugin-priority-config', requireAuth, requireAdmin, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get plugin priority config', error, 'Failed to get plugin priority config', 'PLUGIN_PRIORITY_CONFIG_ERROR');
    }
}));
...
router.post('/plugin-priority-config', requireAuth, requireAdmin, autoLog('network-scan', 'plugin-priority-config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to save plugin priority config', error, 'Failed to save plugin priority config', 'PLUGIN_PRIORITY_CONFIG_ERROR');
    }
}));
...
router.get('/wireshark-vendor-stats', requireAuth, requireAdmin, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get IEEE OUI vendor stats', error, 'Failed to get IEEE OUI vendor stats', 'WIRESHARK_STATS_ERROR');
    }
}));
...
router.post('/update-wireshark-vendors', requireAuth, requireAdmin, autoLog('network-scan', 'update-wireshark-vendors'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to update IEEE OUI vendor database', error, 'Failed to update IEEE OUI vendor database', 'WIRESHARK_UPDATE_ERROR');
    }
}));
...
router.delete('/clear', requireAuth, requireAdmin, autoLog('network-scan', 'clear'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to clear scan data', error, 'Failed to clear scan data', 'CLEAR_ERROR');
    }
}));
...
router.get('/database-size-estimate', requireAuth, requireAdmin, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to estimate database size', error, 'Failed to estimate database size', 'SIZE_ESTIMATE_ERROR');
    }
}));
...
router.get('/:id', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to get IP details', error, 'Failed to get IP details', 'GET_IP_ERROR');
    }
}));
...
router.post('/add-manual', requireAuth, requireAdmin, autoLog('network-scan', 'add-manual'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, `Failed to add manual IP ${ip}`, error, 'Failed to add IP address', 'ADD_IP_ERROR');
    }
}));
...
router.delete('/:id', requireAuth, requireAdmin, autoLog('network-scan', 'delete'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to delete IP', error, 'Failed to delete IP', 'DELETE_IP_ERROR');
    }
}));
...
router.post('/:id/rescan', requireAuth, requireAdmin, autoLog('network-scan', 'rescan'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, `Failed to rescan IP ${ip}`, error, 'Failed to rescan IP address', 'RESCAN_ERROR');
    }
}));
...
router.get('/blacklist', requireAuth, asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to get blacklist', error, 'Failed to get blacklist', 'BLACKLIST_GET_ERROR');
    }
}));
...
router.post('/blacklist/add', requireAuth, requireAdmin, autoLog('network-scan', 'blacklist-add'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, `Failed to add IP ${ip} to blacklist`, error, 'Failed to add IP to blacklist', 'BLACKLIST_ADD_ERROR');
    }
}));
...
router.delete('/blacklist/:ip', requireAuth, requireAdmin, autoLog('network-scan', 'blacklist-remove'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, `Failed to remove IP ${ip} from blacklist`, error, 'Failed to remove IP from blacklist', 'BLACKLIST_REMOVE_ERROR');
    }
}));
...
router.post('/:id/hostname', requireAuth, requireAdmin, autoLog('network-scan', 'update-hostname'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to update hostname', error, 'Failed to update hostname', 'UPDATE_HOSTNAME_ERROR');
    }
}));
...
router.post('/:id/vendor', requireAuth, requireAdmin, autoLog('network-scan', 'update-vendor'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to update vendor', error, 'Failed to update vendor', 'UPDATE_VENDOR_ERROR');
    }
}));
...
router.post('/unified-config', requireAuth, requireAdmin, autoLog('network-scan', 'unified-config'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    try {
        ...
        return sendScanError(res, 'Failed to save unified config', error, 'Failed to save unified config', 'CONFIG_SAVE_ERROR');
    }
}));
...
router.post('/purge', requireAuth, requireAdmin, autoLog('network-scan', 'purge'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to execute purge', error, 'Failed to execute purge', 'PURGE_ERROR');
    }
}));
...
router.post('/purge/history', requireAuth, requireAdmin, autoLog('network-scan', 'purge-history'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to purge history', error, 'Failed to purge history', 'PURGE_HISTORY_ERROR');
    }
}));
...
router.post('/purge/scans', requireAuth, requireAdmin, autoLog('network-scan', 'purge-scans'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to purge scans', error, 'Failed to purge scans', 'PURGE_SCANS_ERROR');
    }
}));
...
router.post('/purge/offline', requireAuth, requireAdmin, autoLog('network-scan', 'purge-offline'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to purge offline scans', error, 'Failed to purge offline scans', 'PURGE_OFFLINE_ERROR');
    }
}));
...
router.post('/purge/latency', requireAuth, requireAdmin, autoLog('network-scan', 'purge-latency'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to purge latency measurements', error, 'Failed to purge latency measurements', 'PURGE_LATENCY_ERROR');
    }
}));
...
router.post('/purge/clear-all', requireAuth, requireAdmin, autoLog('network-scan', 'clear-all'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to clear all scan data', error, 'Failed to clear all scan data', 'CLEAR_ALL_ERROR');
    }
}));
...
router.post('/optimize-database', requireAuth, requireAdmin, autoLog('network-scan', 'optimize-database'), asyncHandler(async (req: AuthenticatedRequest, res) => {
    try {
        ...
        return sendScanError(res, 'Failed to optimize database', error, 'Failed to optimize database', 'OPTIMIZE_ERROR');
    }
}));
