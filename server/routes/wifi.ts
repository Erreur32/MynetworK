...
router.put('/mac-filter', requireAdmin, asyncHandler(async (req, res) => {
...
router.put('/planning', requireAdmin, asyncHandler(async (req, res) => {
  const result = await freeboxApi.updateWifiPlanning(req.body);
  res.json(result);
}));

// POST /api/wifi/wps/start - Start WPS session
router.post('/wps/start', requireAdmin, asyncHandler(async (_req, res) => {
...
router.post('/wps/stop', requireAdmin, asyncHandler(async (_req, res) => {
...
router.post('/temp-disable', requireAdmin, asyncHandler(async (req, res) => {
...
router.delete('/temp-disable', requireAdmin, asyncHandler(async (_req, res) => {
...
router.put('/guest/config', requireAdmin, asyncHandler(async (req, res) => {
...
router.post('/guest/keys', requireAdmin, asyncHandler(async (req, res) => {
...
router.put('/mlo/config', requireAdmin, asyncHandler(async (req, res) => {
